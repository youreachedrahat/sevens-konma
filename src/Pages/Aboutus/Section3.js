...
const Section3 = () => {
  return (
    <div className="section-3 max-sm:w-[100%] max-sm:h-auto max-sm:py-10">
      <div className="section3frame max-sm:w-[100%] max-sm:h-auto">
        <div className="sectionbody max-sm:w-[100%] max-sm:flex-col-reverse max-sm:h-auto max-sm:p-5 max-sm:items-center">
