...
const Section3 = () => {
  return (
    <div className="section-3 max-sm:w-[100%] max-sm:h-auto">
      <div className="section3frame max-sm:w-[100%] max-sm:h-auto">
        <div className="sectionbody max-sm:w-[100%] max-sm:flex-col-reverse max-sm:h-auto max-sm:p-5">
          <div className="section3top-parent max-sm:w-[100%]">
            <div className="section3text max-sm:w-[100%] max-sm:h-auto max-sm:p-5">
