...
const Section2 = () => {
  return (
    <div className="section-2 max-sm:text-left max-sm:h-auto max-sm:w-[100%] max-sm:p-5 max-sm:pb-10 sm:w-auto sm:h-auto sm:p-10">
      <div className="section-21 sm:gap-0 max-sm:w-[100%] max-sm:h-auto sm:w-auto sm:h-auto">
        <div className="section2top max-sm:w-[100%] max-sm:h-auto sm:w-auto sm:h-auto">
          <div className="cta max-sm:w-[100%] max-sm:h-auto">
            <p className="book-your-demo-today  max-sm:pr-5 max-sm:pl-0">
              <span className="book-your-demo-today1 max-sm:text-[48px] max-sm:h-auto max-sm:leading-7 sm:w-auto sm:h-auto sm:text-5xl md:text-[62px] lg:text-[72px]">
            ...
            <p className="whatsapp-us-on-44-7537-180047">
              <span className="whatsapp-us-on-44-7537-1800471 max-sm:leading-9">
                <span>
                  <span className="max-sm:text-[24px] sm:w-auto sm:h-auto sm:text-3xl md:text-[40px]">WhatsApp Us on </span>
                </span>
                <span className="span max-sm:block">
                  <b className="b max-sm:text-[28px] max-sm:h-auto sm:w-auto sm:h-auto sm:text-3xl">+44 7537 180047</b>
        ...
        <div className="section2text2 max-sm:flex-col max-sm:gap-20 sm:w-auto sm:h-auto sm:flex-col md:gap-4 md:pt-2 md:flex-row">
          <div className="text1 max-sm:text-[25px] max-sm:text-center max-sm:mx-auto sm:w-auto sm:h-auto sm:text-3xl">
