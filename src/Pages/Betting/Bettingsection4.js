...
const Bettingsection4 = () => {
  return (
    <div className="bettingsection4 max-sm:px-0 max-sm:w-auto max-sm:h-auto max-sm:py-0">
      <div className="bettingbody-4 max-sm:w-auto max-sm:h-auto max-sm:flex-col-reverse max-sm:gap-0">
        <img
          className="bettingimage4-icon max-sm:w-auto max-sm:h-auto"
          alt=""
          src="/bettingimage4@2x.png"
        />
        <div className="bettingsection4-left max-sm:w-auto max-sm:h-auto">
          <div className="textbody max-sm:w-auto max-sm:h-auto max-sm:px-5 max-sm:py-5">
            ...
            <b className="textindigobold max-sm:w-auto max-sm:h-auto max-sm:text-justify max-sm:tracking-tighter">
