...
const HomepageSection4 = () => {
  return (
    <div className="homepagesection4 max-sm:w-full">
      <div className="homepage4body max-sm:w-full">
        ...
        <div className="body4 max-sm:flex-col-reverse max-sm:gap-20">
          ...
          {/* <div className="clientslogo max-sm:grid max-sm:grid-cols-2 max-sm:gap-y-auto max-sm:gap-x-0 max-sm:w-full">
  <div className="flex justify-start flex-wrap max-sm:gap-y-7">
    <img className="mask-group-icon" alt="" src="/mask-group@2x.png" />
  ...
  <div className="flex justify-end flex-wrap max-sm:gap-y-7">
    ...
    <img className="mask-group-icon" alt="" src="/mask-group9@2x.png" />
          ...
          <div className="body4right max-sm:w-full">
            <img
              ...
              src={money}
            />
        <div className="headingwhite max-sm:w-full max-sm:self-center max-sm:text-center max-sm:font-bold">Our Clients</div>

            <div className="tagline max-sm:text-center max-sm:w-full">why sevens gaming?</div>
            <div className="text max-sm:text-center max-sm:px-4 max-sm:w-full max-sm:text-[18px]">
