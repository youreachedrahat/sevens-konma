  ...
  return (
    <div className="casinosection1">
      ...
      <div className="casinoTop">
        <div className="rectangle max-sm:pl-10">
          <b className="title max-sm:h-auto max-sm:text-center max-sm:text-4xl max-sm:pl-0  pl-6 text-[100%]" >{`Online Live Casino Games Integrations`}</b>
        </div>
      <HorizontalRule/>
        
      </div>
       
        <div className="text-white max-sm:w-auto max-sm:h-auto max-sm:pl-7 max-sm:pr-7 max-sm:text-justify text-50% max-sm:text-[20px]">
