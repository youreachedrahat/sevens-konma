    ...
    <div className="casinosection2 max-sm:px-0">
      <div className="casinossection-2 max-sm:w-auto max-sm:h-auto">
        <div className="casino2top  max-sm:flex-col max-sm:pt-0 max-sm:gap-0">
          <b className="title2indigo max-sm:w-auto max-sm:h-auto max-sm:pt-10 max-sm:text-center max-sm:px-25">Casino Provider Integrations</b>
          <img className="casinoimage1-icon max-sm:pl-10 max-sm:h-25 max-sm:ml-15" alt="" src="/casinoimage1@2x.png" />
        </div>
